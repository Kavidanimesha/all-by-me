        ...
        <CardActionArea>
          ...
          <Grid container>
            <Grid item xs={12} align='center' marginTop={2} marginBottom={2}>
              <Button variant="contained" color = 'success' onClick={handleClickOpenDoctor}>
                Deliver
              </Button>
            </Grid>
            <Dialog open={openDoctor} onClose={handleCloseDoctor}>
              <Grid container style={{padding: 10}}>
                <DialogContent>
                  <DialogActions>
                    <Button variant="outlined" color = 'error' onClick={handleCloseDoctor}> Close </Button>
