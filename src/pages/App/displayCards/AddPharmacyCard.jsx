...
function AddPharmacyCard() {
  return (
    <>
        <Grid item xs={12} align='center'>
            <Typography variant='h4'> Add Pharmacy Details </Typography>
        </Grid>
        ...
        >
            <Form>
                <Grid container display={'flex'} flexDirection={'column'} spacing={2}>
                    <Grid item xs={12}>
                        <TextFieldWrapper name='name' label='Pharmacy Name' />
                    </Grid>
                    <Grid item xs={12}>
...
export default AddPharmacyCard
